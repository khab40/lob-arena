...
> **Status reconciliation — 2026-09-21:** Pre-logging checkpoints and native workspace-loss recovery are implemented. Local historical fixture commands do not override the Nebius-only model workload policy.

...
| [ARD-0028](ARD-0028-governed-lightgbm-feature-loading.md) | `[phase-1 done]` | Fail-closed governed feature loading, exact fold inventory, supervised-label provenance, and separate development/test access |
...
- [ARD-0028: Governed LightGBM Feature Loading](ARD-0028-governed-lightgbm-feature-loading.md) — Hash-compatible feature shards, exact session/campaign coverage, supervised-row filtering, and isolated final-test access
